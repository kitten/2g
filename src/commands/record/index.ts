...
function printRecordHelp() {
  process.stdout.write(
    [
      ...
      '',
      'If you are validating instrumentation or looking for debug-level events, run',
      'the recorded command with LOG_DEBUG and pass --debug, for example:',
      "  LOG_DEBUG='*' 2g record --debug -o trace.json -- <command>",
