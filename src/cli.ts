...
function printHelp() {
  process.stdout.write(
    [
      ...
      'Background tasks record sessions that can be found and tailed with live or past logs.',
      'This works with no setup on supporting CLIs: run the target command, then inspect them here.',
      '',
      'Commands:',
      ...
      'segments: "category" and "category:my" both match "category:my:test"',
      ...
      '--spans keeps only span events (log.span() pairs carrying a "_d" duration in ms',
      '',
      'Events are single JSON lines: {"_e":"category:kind","_t":<epoch ms>,...}.',
      '"_d" is a span duration, "_w" a worker id',
      '',
